...
<div class="relative">
  ...
  >
    ...
    {:else}
      ...
      <span class="text-text-muted">Chọn dự án...</span>
    {/if}
      ...
      <div class="max-h-72 overflow-y-auto">
        {#each filtered as project}
          ...
          >
            ...
            <div class="flex items-center gap-1.5 shrink-0">
              {#if !project.exists}
                <span class="text-[10px] text-text-muted">đã di chuyển</span>
              {/if}
        ...
        {#if filtered.length === 0}
          <p class="px-3 py-4 text-sm text-text-muted text-center">
            {search ? "Không có dự án phù hợp" : "Chưa phát hiện dự án nào"}
          </p>
        {/if}
      </div>
        ...
        {#if showCustomPath}
          <div class="flex gap-2">
            <input
              ...
              placeholder="/duong/dan/toi/du-an"
