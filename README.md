<p align="center">
  <img src="src/lib/assets/logo.svg" width="260" alt="Harness">
</p>
...
Harness gives you a visual interface to configure, manage, and use [Claude Code](https://docs.anthropic.com/en/docs/claude-code) -- the AI coding assistant from Anthropic. Instead of editing JSON files and markdown by hand, Harness lets you manage everything through a modern desktop app.

## Screenshots

<p align="center">
  <img src="screenshots/dashboard-harness.png" width="800" alt="Dashboard">
...
Harness reads and writes the same configuration files that Claude Code uses:
